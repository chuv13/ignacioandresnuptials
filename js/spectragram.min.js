...
function(e) {
    var t = {
        ...
        display: function(t) {
            ...
            if (0 === t.data.length)
                n.$elem.append(e(n.options.wrapEachWith).append(n.options.notFoundMsg));
            else
                for (var o = 0; c > o; o++)
                    a = "small" == s ? t.data[o].images.thumbnail.url : "medium" == s ? t.data[o].images.low_resolution.url : t.data[o].images.standard_resolution.url,
